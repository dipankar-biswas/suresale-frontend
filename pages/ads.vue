<template>
    ...
    <div class="content">
        <div class="max-w-screen-2xl flex justify-between gap-x-4 h-full mx-auto px-4 py-9">
            <div class="sidebar basis-72">
                <div>
                    <div class="s-browse-market mb-8">
                        <h4 class="text-xl font-semibold mb-4">Browse Marketplace</h4>
                            <form>
                                <div class="flex">
            ...
            <div class="px-4 w-[calc(100%-basis-72)]">
                <!-- Categories -->
                ...
                <div class="mx-auto w-full max-w-screen-2xl px-4 py-2">
                    <div class="bg-white">
                        <div class="title flex justify-between items-center gap-3 px-3 py-3 border-b-2 mb-4">
                            <h4 class="text-xl font-semibold">Premium Ads</h4>
                            <h5>Want to sell faster? Place your ad here</h5>
                        </div>
                        <div class="adses rounded grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-5">
                ...
                <div class="mx-auto w-full max-w-screen-2xl px-4 py-2">
                    <div class="bg-white">
                        ...
                        <div class="flex flex-cols-1  lg:flex-cols-2 gap-x-5 gap-y-5 h-full">
                            <div class="adses basis-9/12 rounded grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-5">
                                <AdsItem>
                            ...
                            <div class="ads-banner basis-3/12">
                ...
                <div class="mx-auto w-full max-w-screen-2xl px-4 py-2">
                    <div class="bg-white">
                        <div class="title flex justify-between items-center gap-3 px-3 py-3 border-b-2 mb-4">
                            <h4 class="text-xl font-semibold">Regular Ads</h4>
                        </div>
                        <div class="flex flex-cols-1  lg:flex-cols-2 gap-x-5 gap-y-5 h-full">
                            <div class="adses basis-9/12 rounded grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-5">
                                <AdsItem>
