<template>
    ...
    <footer class="bg-white m-4 dark:bg-gray-800">
        ...
        <!-- <div class="border-b-2 w-full mx-auto max-w-screen-2xl p-4 md:flex md:items-center md:justify-between">
            <div class="w-full p-4 text-center bg-white sm:p-8 dark:bg-gray-800">
        ...
        <div class="w-full mx-auto max-w-screen-2xl py-4 px-2 md:flex md:items-center md:justify-between">
            <div class="items-center justify-between md:flex md:w-auto">
                <ul class="font-medium text-sm flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-6 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <li>
                        <a href="#"
                            class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Privecy and Policy</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Terms and Conditions</a>
                    </li>
                    <li>
                        <a href="#"
